...
- `epics_tools_services_elastic` (Elasticsearch -- stores alarm history)
- `epics_tools_services_kafka` (Kafka and Zookeeper -- alarm message bus)
...
- hosts: all
  ...
  roles:
    ...
    - nsls2.epics_services.epics_tools_services_phoebus_alarm
```
