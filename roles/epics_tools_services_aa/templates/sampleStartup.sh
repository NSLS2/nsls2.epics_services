...
export JAVA_OPTS_ENGINE="{{ aa_java_opts_engine }}"
export JAVA_OPTS_RETRIEVAL="{{ aa_java_opts_retrieval }}"
export JAVA_OPTS_ETL="{{ aa_java_opts_etl }}"
export JAVA_OPTS_MGMT="{{ aa_java_opts_mgmt }}"

# Set up Tomcat home
export TOMCAT_HOME="{{aa_deploy_location}}/apache-tomcat-{{ aa_dependencies_tomcat_version }}"
