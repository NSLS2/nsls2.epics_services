...
# Extract the Tomcat folder name from the distribution tarball filename
# This ensures we use the correct version that was just extracted
TOMCAT_VERSION_FOLDER=`basename ${TOMCAT_DISTRIBUTION} .tar.gz`
